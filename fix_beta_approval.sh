...
# 2. 执行数据库表结构修复
echo "\n2. 修复数据库表结构..."
mysql -u kbitai0302 -pkbitai2026 kbitai0302 < fix_database_schema.sql

# 3. 测试内测申请批准功能
echo "\n3. 测试内测申请批准功能..."
cat > test_beta_fix.php << 'EOF'
<?php
...
php test_beta_fix.php
rm test_beta_fix.php

# 5. 清理临时文件
echo "\n5. 清理临时文件..."
rm -f test_beta_fix.php
