...
class Database
{
    ...
    private float $slowQueryThreshold = 1.0; // 慢查询阈值：1秒
    ...
    public function query(string $sql, array $params = []): array
    {
        ...
        if ($duration > $this->slowQueryThreshold) {
            ...
            error_log(sprintf('[慢查询] %.3fs - %s', $duration, $sql));
        }
    ...
    public function getStats(): array
    {
        return [
            ...
            'avg_query_time' => $this->queryCount > 0 ? $this->queryTime / $this->queryCount : 0,
            'slow_queries' => count($this->slowQueries),
            'connection_status' => $this->connection !== null ? 'connected' : 'disconnected'
        ];
    }
